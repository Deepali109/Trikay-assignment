...
//   [`& .${StepConnector.line}`]: {
//     borderColor: "transparent", // Hide default line
//     borderLeftWidth: 8, // Broad vertical line
//     borderRadius: 1,
//     marginLeft: "9px",
//     position: "relative",
//     "&:before": {
//       content: '""',
//       position: "absolute",
//       left: "-16px", // Adjust to align with hexagons
//       top: "50%",
...
export default function StudyJourney() {
  ...
  return (
    ...
    >
      <div className="flex">
        <div className="">
          <img src={hexaImage} alt="Logo" className="h-24 w-28 -ml-7 -mt-10" />
        </div>
